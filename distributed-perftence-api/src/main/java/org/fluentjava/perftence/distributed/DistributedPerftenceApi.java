...
public final class DistributedPerftenceApi {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(DistributedPerftenceApi.class);
    ...
    public DistributedPerftenceApi(final TestFailureNotifier testFailureNotifier,
        ...
        this.executorService = executorServiceFactory().newFixedThreadPool(2, "remote-reporter");
    ...
    public DistributedPerftenceApi reportingThreads(final int threads) {
        this.executorService = executorServiceFactory().newFixedThreadPool(threads, "remote-reporter");
        return this;
    }
    ...
    public DistributedPerformanceTest test(final String id) {
        final RemoteLatencyReporter remoteReporter = reporterFactory().forRemoteReporting(id, reportsTo());
        reporters().put(id, remoteReporter);
        return new DistributedPerformanceTest(id, this.testFailureNotifier, this.executorService, new RunNotifier() {
