...
public class LastSecondStatisticsTest {
    private final static Logger LOG = LoggerFactory.getLogger(LastSecondStatisticsTest.class);

    @Test
    public void test() throws InterruptedException {
        final LastSecondStatistics statistics = new LastSecondStatistics(new DefaultLatencyProviderFactory());
