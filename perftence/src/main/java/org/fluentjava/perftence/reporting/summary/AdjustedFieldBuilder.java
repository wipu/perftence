...
public final class AdjustedFieldBuilder {
    ...
    AdjustedFieldBuilder(final FieldFormatter fieldFormatter, final FieldAdjuster fieldAdjuster) {
    ...
    private static class Formatted implements AdjustedField<String> {
        ...
        public Formatted(final AdjustedField<?> field, final FieldFormatter fieldFormatter) {
            this.field = field;
