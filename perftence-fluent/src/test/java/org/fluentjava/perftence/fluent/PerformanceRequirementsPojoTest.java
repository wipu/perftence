...
public class PerformanceRequirementsPojoTest {
    ...
    @Test
    public void build() {
        final PerformanceRequirementsBuilder builder = PerformanceRequirementsPojo.builder();
        assertNotNull(builder);
        final PerformanceRequirements req = builder.max(150).average(100).median(90).percentile90(140).percentile95(145)
        ...
        final PercentileRequirement[] percentileRequirements = req.percentileRequirements();
